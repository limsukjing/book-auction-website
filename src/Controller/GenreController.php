...
class GenreController extends AbstractController
{
     ...
     * @IsGranted("ROLE_ADMIN", message="Access Denied: Only users with ROLE_ADMIN are allowed to add genre entries.")
     */
     ...
     * @IsGranted("ROLE_ADMIN", message="Access Denied: Only users with ROLE_ADMIN are allowed to edit genre entries.")
     */
     ...
     * @IsGranted("ROLE_ADMIN", message="Access Denied: Only users with ROLE_ADMIN are allowed to delete genre entries.")
     */
