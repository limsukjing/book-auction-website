 ...
 */
final class Version20190413224708 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, genre_id INT DEFAULT NULL, seller_id INT DEFAULT NULL, highest_bidder_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, image LONGTEXT NOT NULL, isbn BIGINT NOT NULL, summary LONGTEXT NOT NULL, reserve_price DOUBLE PRECISION NOT NULL, starting_price DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_CBE5A3314296D31F (genre_id), INDEX IDX_CBE5A3318DE820D9 (seller_id), INDEX IDX_CBE5A331C03ECC6F (highest_bidder_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
